...
extension Router {
  ...
  public static func `case`<B>(
    ...
    .case(casePath, at: path, chainingTo: router())
  }
  ...
  public static func delete<B>(
    ...
    .delete(casePath, at: path, chainingTo: router())
  }
  ...
  public static func get<B>(
    ...
    .get(casePath, at: path, chainingTo: router())
  }
  ...
  public static func post<B>(
    ...
    .post(casePath, at: path, chainingTo: router())
  }
}
